...
- [Alpine Linux](https://alpinelinux.org), which is our
  operating system of choice
- X11, which is our windowing backend[^1] of choice
- [ghcup](https://www.haskell.org/ghcup/#quick-install") and stack,
  which will manage some our [Haskell](<https://en.wikipedia.org/wiki/Haskell_(programming_language)>) dependencies
- [xmonad](https://xmonad.org), which is our windowing frontend
  of choice.
