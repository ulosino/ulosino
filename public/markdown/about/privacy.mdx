...
"Request" refers to when You download or upload data from remote servers. "Request Host" refers to Your electronic device that makes Requests. "Delivery Software" refers to software that Requests interface with, and is hosted on a remote server.
...
This Privacy Notice may change without any prior notice. **Effective from 17th February, 2022**.
