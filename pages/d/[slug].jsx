...
export default function GuidePage({ source, metadata, componentNames }) {
  ...
  return (
    <UIProvider>
      ...
      <Stack direction={["column", "column", "row"]} spacing={8} as="main">
        ...
        <Stack spacing={2} as="section">
          ...
          <Tag variant="solid" bg="glass.600">
...
export const getStaticProps = async ({ params }) => {
  const filePath = path.join(`public/content/d`, `${params.slug}.mdx`);
...
export const getStaticPaths = async () => {
  const pageDataPath = path.join(process.cwd(), "public/content/d");
