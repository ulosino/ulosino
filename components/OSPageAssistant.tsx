...
# donateLiberapay: ""`;
  ...
  return (
    <>
      <DarkMode>
        <Button leftIcon={<HiOutlinePlus />} onClick={onOpen}>
          Get Started
        </Button>
      </DarkMode>
      <Drawer isOpen={isOpen} onClose={onClose} placement="left" size="lg">
        <DrawerOverlay />
        <DrawerContent rounded="xl" m={5}>
                  ...
                  {finalPage ? (
                    <Stack direction="column" spacing={5}>
                      ...
                      <Text>
                        ...
                        example, <Code>ubuntu.mdx</Code>). Underneath, paste the
                        OS Page. Then choose to create a new branch to open a
